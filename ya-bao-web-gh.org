...
* sitemap
  ...
  #+begin_src lisp :tangle create-sitemap.lisp
    ...
    (defun generate-sitemap (urls &optional (filename "sitemap.xml"))
      ...
      (let* ((name1 (pathname-name filename))
	     (type1 (pathname-type filename))
	     (fn1 (uiop:make-pathname*
		   :directory '(:absolute "home" "screw" "Documents" "ya-bao-web")
		   :name name1 :type type1)))
	(with-open-file (file fn1
			      :direction :output
